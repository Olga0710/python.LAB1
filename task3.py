...
folders = [r"C:\Users\User\Projects\C++.SEM1",
           r"C:\Users\User\Projects\C++.SEM2",
...
for (year, month, ext), (cnt, size, lines) in items:
    ...
    row = [year, month, ext, cnt, size, lines]
    result.append(row)
    
with open("lab1_1.csv", "w", newline="", encoding="utf-8") as f:
    writer = csv.writer(f, delimiter=";")
    writer.writerow(["year", "mon", "ext", "cnt", "size", "lines"])
